...
function Login() {
	...
	const zombieThoughts = [
		...
		'putangina mo',
		'putangina mo rin',
		'putangina mo rin, ulol',
		'putangina mo rin, ulol, bobo',
		'san mo lalagay',
	...
	const handleLogin = async () => {
		try {
			...
			if (response.data.success) {
				...
				// Automatically route admin to dashboard
				setTimeout(() => {
		...
		<div className="haunted-background min-h-screen flex items-center justify-center py-10 px-3 sm:px-5 lg:px-7">
			...
			<div className="haunted-card max-w-sm w-full bg-gray-900 rounded-xl overflow-hidden">
				...
				<div className="p-6 md:p-8 relative z-10">
					...
					{message && (
						<div className={`haunted-message mb-6 p-4 rounded-lg text-center font-medium ${messageType === 'success'
